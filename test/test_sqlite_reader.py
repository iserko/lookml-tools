...
def test_get_definitions():
    ...
    c.execute(
        "insert into test(file, type, name, definition) values('test/basic.view.lkml','dimension','tier','this is a new description');"
    )
    conn.commit()
    conn.close()
    ...
    assert results[0] == {
        "file": "test/basic.view.lkml",
        "type": "dimension",
        "name": "tier",
        "definition": "this is a new description",
    }
